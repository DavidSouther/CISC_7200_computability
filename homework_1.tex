...
Then after a T form a instruction, register j will hold either $x+m_a$ or $m_a$.

For a T form b instruction, by the above logic after a T form b instruction, the register j will hold $x+m_a$ or $m_a$.
...
By induction, this process can be extended to n T form c instructions, so long as the chain is ended by a form b instruction and possible started with a form a instruction.

\section*{Excercise 3.4}
