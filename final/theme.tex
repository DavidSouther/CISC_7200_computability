...
%%% ----- TikZ styles -----
\tikzset{
  craneblob/.style={draw=color_mute, line width=0.7pt, rounded corners=10pt, fill=white},
  cranedivide/.style={draw=color_mute, line width=0.7pt, decorate, decoration={random steps, segment length=8pt, amplitude=2.5pt}},
  cranelabel/.style={font=\rmfamily\itshape, text=color_text},
  cranedot/.style={circle, fill=color_text, inner sep=0pt, minimum size=4pt},
  cranewit/.style={circle, fill=color_primary, draw=color_text, line width=0.4pt, inner sep=0pt, minimum size=5pt},
  cranerefdot/.style={circle, fill=color_accent, draw=color_accent, inner sep=0pt, minimum size=5pt},
  cranenode/.style={font=\rmfamily, text=color_text, inner sep=4pt},
  cranearrow/.style={-{Stealth[length=4pt, width=4pt]}, draw=color_text, line width=0.6pt},
}
